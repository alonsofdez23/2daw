...
INSERT INTO emple(emp_no, apellidos, salario, comision, fecha_alt, oficio, jefe_id, depart_id)
VALUES ('1111', 'GARCÍA', 2345.23, NULL, '2018-11-04 14:00:00', 'PROGRAMADOR', NULL, 4),
       ('2222', 'PÉREZ', 1804.87, 230.00, '2015-06-02 18:23:15', 'VENDEDOR', NULL, 3),
       ('3333', 'MARTÍNEZ', 1500.00, 200.00, '2016-02-02 14:00:00', 'EMPLEADO', 2, 3);
